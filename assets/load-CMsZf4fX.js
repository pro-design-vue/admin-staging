import{d as c1,a3 as H,a5 as M1,ak as y1,j as m1,aJ as b1,h as E,al as x1}from"./index-C1GS2ABb.js";const o1=/^[a-z0-9]+(-[a-z0-9]+)*$/,z=(a,e,n,s="")=>{const t=a.split(":");if(a.slice(0,1)==="@"){if(t.length<2||t.length>3)return null;s=t.shift().slice(1)}if(t.length>3||!t.length)return null;if(t.length>1){const o=t.pop(),i=t.pop(),c={provider:t.length>0?t[0]:s,prefix:i,name:o};return e&&!O(c)?null:c}const l=t[0],r=l.split("-");if(r.length>1){const o={provider:s,prefix:r.shift(),name:r.join("-")};return e&&!O(o)?null:o}if(n&&s===""){const o={provider:s,prefix:"",name:l};return e&&!O(o,n)?null:o}return null},O=(a,e)=>a?!!((e&&a.prefix===""||a.prefix)&&a.name):!1,i1=Object.freeze({left:0,top:0,width:16,height:16}),P=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),V=Object.freeze({...i1,...P}),q=Object.freeze({...V,body:"",hidden:!1});function C1(a,e){const n={};!a.hFlip!=!e.hFlip&&(n.hFlip=!0),!a.vFlip!=!e.vFlip&&(n.vFlip=!0);const s=((a.rotate||0)+(e.rotate||0))%4;return s&&(n.rotate=s),n}function $(a,e){const n=C1(a,e);for(const s in q)s in P?s in a&&!(s in n)&&(n[s]=P[s]):s in e?n[s]=e[s]:s in a&&(n[s]=a[s]);return n}function A1(a,e){const n=a.icons,s=a.aliases||Object.create(null),t=Object.create(null);function l(r){if(n[r])return t[r]=[];if(!(r in t)){t[r]=null;const o=s[r]&&s[r].parent,i=o&&l(o);i&&(t[r]=[o].concat(i))}return t[r]}return Object.keys(n).concat(Object.keys(s)).forEach(l),t}function j1(a,e,n){const s=a.icons,t=a.aliases||Object.create(null);let l={};function r(o){l=$(s[o]||t[o],l)}return r(e),n.forEach(r),$(a,l)}function d1(a,e){const n=[];if(typeof a!="object"||typeof a.icons!="object")return n;a.not_found instanceof Array&&a.not_found.forEach(t=>{e(t,null),n.push(t)});const s=A1(a);for(const t in s){const l=s[t];l&&(e(t,j1(a,t,l)),n.push(t))}return n}const Z1={provider:"",aliases:{},not_found:{},...i1};function B(a,e){for(const n in e)if(n in a&&typeof a[n]!=typeof e[n])return!1;return!0}function u1(a){if(typeof a!="object"||a===null)return null;const e=a;if(typeof e.prefix!="string"||!a.icons||typeof a.icons!="object"||!B(a,Z1))return null;const n=e.icons;for(const t in n){const l=n[t];if(!t||typeof l.body!="string"||!B(l,q))return null}const s=e.aliases||Object.create(null);for(const t in s){const l=s[t],r=l.parent;if(!t||typeof r!="string"||!n[r]&&!s[r]||!B(l,q))return null}return e}const K=Object.create(null);function S1(a,e){return{provider:a,prefix:e,icons:Object.create(null),missing:new Set}}function x(a,e){const n=K[a]||(K[a]=Object.create(null));return n[e]||(n[e]=S1(a,e))}function h1(a,e){return u1(e)?d1(e,(n,s)=>{s?a.icons[n]=s:a.missing.add(n)}):[]}function O1(a,e,n){try{if(typeof n.body=="string")return a.icons[e]={...n},!0}catch{}return!1}let Z=!1;function v1(a){return typeof a=="boolean"&&(Z=a),Z}function L1(a){const e=typeof a=="string"?z(a,!0,Z):a;if(e){const n=x(e.provider,e.prefix),s=e.name;return n.icons[s]||(n.missing.has(s)?null:void 0)}}function p1(a,e){const n=z(a,!0,Z);if(!n)return!1;const s=x(n.provider,n.prefix);return e?O1(s,n.name,e):(s.missing.add(n.name),!0)}function T1(a,e){if(typeof a!="object")return!1;if(typeof e!="string"&&(e=a.provider||""),Z&&!e&&!a.prefix){let t=!1;return u1(a)&&(a.prefix="",d1(a,(l,r)=>{p1(l,r)&&(t=!0)})),t}const n=a.prefix;if(!O({prefix:n,name:"a"}))return!1;const s=x(e,n);return!!h1(s,a)}const f1=Object.freeze({width:null,height:null}),g1=Object.freeze({...f1,...P}),P1=/(-?[0-9.]*[0-9]+[0-9.]*)/g,z1=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function W(a,e,n){if(e===1)return a;if(n=n||100,typeof a=="number")return Math.ceil(a*e*n)/n;if(typeof a!="string")return a;const s=a.split(P1);if(s===null||!s.length)return a;const t=[];let l=s.shift(),r=z1.test(l);for(;;){if(r){const o=parseFloat(l);isNaN(o)?t.push(l):t.push(Math.ceil(o*e*n)/n)}else t.push(l);if(l=s.shift(),l===void 0)return t.join("");r=!r}}function V1(a,e="defs"){let n="";const s=a.indexOf("<"+e);for(;s>=0;){const t=a.indexOf(">",s),l=a.indexOf("</"+e);if(t===-1||l===-1)break;const r=a.indexOf(">",l);if(r===-1)break;n+=a.slice(t+1,l).trim(),a=a.slice(0,s).trim()+a.slice(r+1)}return{defs:n,content:a}}function I1(a,e){return a?"<defs>"+a+"</defs>"+e:e}function H1(a,e,n){const s=V1(a);return I1(s.defs,e+s.content+n)}const B1=a=>a==="unset"||a==="undefined"||a==="none";function F1(a,e){const n={...V,...a},s={...g1,...e},t={left:n.left,top:n.top,width:n.width,height:n.height};let l=n.body;[n,s].forEach(g=>{const h=[],b=g.hFlip,y=g.vFlip;let M=g.rotate;b?y?M+=2:(h.push("translate("+(t.width+t.left).toString()+" "+(0-t.top).toString()+")"),h.push("scale(-1 1)"),t.top=t.left=0):y&&(h.push("translate("+(0-t.left).toString()+" "+(t.height+t.top).toString()+")"),h.push("scale(1 -1)"),t.top=t.left=0);let w;switch(M<0&&(M-=Math.floor(M/4)*4),M=M%4,M){case 1:w=t.height/2+t.top,h.unshift("rotate(90 "+w.toString()+" "+w.toString()+")");break;case 2:h.unshift("rotate(180 "+(t.width/2+t.left).toString()+" "+(t.height/2+t.top).toString()+")");break;case 3:w=t.width/2+t.left,h.unshift("rotate(-90 "+w.toString()+" "+w.toString()+")");break}M%2===1&&(t.left!==t.top&&(w=t.left,t.left=t.top,t.top=w),t.width!==t.height&&(w=t.width,t.width=t.height,t.height=w)),h.length&&(l=H1(l,'<g transform="'+h.join(" ")+'">',"</g>"))});const r=s.width,o=s.height,i=t.width,c=t.height;let d,u;r===null?(u=o===null?"1em":o==="auto"?c:o,d=W(u,i/c)):(d=r==="auto"?i:r,u=o===null?W(d,c/i):o==="auto"?c:o);const v={},f=(g,h)=>{B1(h)||(v[g]=h.toString())};f("width",d),f("height",u);const k=[t.left,t.top,i,c];return v.viewBox=k.join(" "),{attributes:v,viewBox:k,body:l}}const E1=/\sid="(\S+)"/g,q1="IconifyId"+Date.now().toString(16)+(Math.random()*16777216|0).toString(16);let D1=0;function N1(a,e=q1){const n=[];let s;for(;s=E1.exec(a);)n.push(s[1]);if(!n.length)return a;const t="suffix"+(Math.random()*16777216|Date.now()).toString(16);return n.forEach(l=>{const r=typeof e=="function"?e(l):e+(D1++).toString(),o=l.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");a=a.replace(new RegExp('([#;"])('+o+')([")]|\\.[a-z])',"g"),"$1"+r+t+"$3")}),a=a.replace(new RegExp(t,"g"),""),a}const D=Object.create(null);function R1(a,e){D[a]=e}function N(a){return D[a]||D[""]}function G(a){let e;if(typeof a.resources=="string")e=[a.resources];else if(e=a.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:a.path||"/",maxURL:a.maxURL||500,rotate:a.rotate||750,timeout:a.timeout||5e3,random:a.random===!0,index:a.index||0,dataAfterTimeout:a.dataAfterTimeout!==!1}}const Q=Object.create(null),A=["https://api.simplesvg.com","https://api.unisvg.com"],L=[];for(;A.length>0;)A.length===1||Math.random()>.5?L.push(A.shift()):L.push(A.pop());Q[""]=G({resources:["https://api.iconify.design"].concat(L)});function G1(a,e){const n=G(e);return n===null?!1:(Q[a]=n,!0)}function U(a){return Q[a]}const Q1=()=>{let a;try{if(a=fetch,typeof a=="function")return a}catch{}};let X=Q1();function U1(a,e){const n=U(a);if(!n)return 0;let s;if(!n.maxURL)s=0;else{let t=0;n.resources.forEach(r=>{t=Math.max(t,r.length)});const l=e+".json?icons=";s=n.maxURL-t-n.path.length-l.length}return s}function $1(a){return a===404}const K1=(a,e,n)=>{const s=[],t=U1(a,e),l="icons";let r={type:l,provider:a,prefix:e,icons:[]},o=0;return n.forEach((i,c)=>{o+=i.length+1,o>=t&&c>0&&(s.push(r),r={type:l,provider:a,prefix:e,icons:[]},o=i.length),r.icons.push(i)}),s.push(r),s};function W1(a){if(typeof a=="string"){const e=U(a);if(e)return e.path}return"/"}const X1=(a,e,n)=>{if(!X){n("abort",424);return}let s=W1(e.provider);switch(e.type){case"icons":{const l=e.prefix,o=e.icons.join(","),i=new URLSearchParams({icons:o});s+=l+".json?"+i.toString();break}case"custom":{const l=e.uri;s+=l.slice(0,1)==="/"?l.slice(1):l;break}default:n("abort",400);return}let t=503;X(a+s).then(l=>{const r=l.status;if(r!==200){setTimeout(()=>{n($1(r)?"abort":"next",r)});return}return t=501,l.json()}).then(l=>{if(typeof l!="object"||l===null){setTimeout(()=>{l===404?n("abort",l):n("next",t)});return}setTimeout(()=>{n("success",l)})}).catch(()=>{n("next",t)})},J1={prepare:K1,send:X1};function Y1(a){const e={loaded:[],missing:[],pending:[]},n=Object.create(null);a.sort((t,l)=>t.provider!==l.provider?t.provider.localeCompare(l.provider):t.prefix!==l.prefix?t.prefix.localeCompare(l.prefix):t.name.localeCompare(l.name));let s={provider:"",prefix:"",name:""};return a.forEach(t=>{if(s.name===t.name&&s.prefix===t.prefix&&s.provider===t.provider)return;s=t;const l=t.provider,r=t.prefix,o=t.name,i=n[l]||(n[l]=Object.create(null)),c=i[r]||(i[r]=x(l,r));let d;o in c.icons?d=e.loaded:r===""||c.missing.has(o)?d=e.missing:d=e.pending;const u={provider:l,prefix:r,name:o};d.push(u)}),e}function k1(a,e){a.forEach(n=>{const s=n.loaderCallbacks;s&&(n.loaderCallbacks=s.filter(t=>t.id!==e))})}function a2(a){a.pendingCallbacksFlag||(a.pendingCallbacksFlag=!0,setTimeout(()=>{a.pendingCallbacksFlag=!1;const e=a.loaderCallbacks?a.loaderCallbacks.slice(0):[];if(!e.length)return;let n=!1;const s=a.provider,t=a.prefix;e.forEach(l=>{const r=l.icons,o=r.pending.length;r.pending=r.pending.filter(i=>{if(i.prefix!==t)return!0;const c=i.name;if(a.icons[c])r.loaded.push({provider:s,prefix:t,name:c});else if(a.missing.has(c))r.missing.push({provider:s,prefix:t,name:c});else return n=!0,!0;return!1}),r.pending.length!==o&&(n||k1([a],l.id),l.callback(r.loaded.slice(0),r.missing.slice(0),r.pending.slice(0),l.abort))})}))}let t2=0;function n2(a,e,n){const s=t2++,t=k1.bind(null,n,s);if(!e.pending.length)return t;const l={id:s,icons:e,callback:a,abort:t};return n.forEach(r=>{(r.loaderCallbacks||(r.loaderCallbacks=[])).push(l)}),t}function e2(a,e=!0,n=!1){const s=[];return a.forEach(t=>{const l=typeof t=="string"?z(t,e,n):t;l&&s.push(l)}),s}var s2={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function l2(a,e,n,s){const t=a.resources.length,l=a.random?Math.floor(Math.random()*t):a.index;let r;if(a.random){let p=a.resources.slice(0);for(r=[];p.length>1;){const _=Math.floor(Math.random()*p.length);r.push(p[_]),p=p.slice(0,_).concat(p.slice(_+1))}r=r.concat(p)}else r=a.resources.slice(l).concat(a.resources.slice(0,l));const o=Date.now();let i="pending",c=0,d,u=null,v=[],f=[];typeof s=="function"&&f.push(s);function k(){u&&(clearTimeout(u),u=null)}function g(){i==="pending"&&(i="aborted"),k(),v.forEach(p=>{p.status==="pending"&&(p.status="aborted")}),v=[]}function h(p,_){_&&(f=[]),typeof p=="function"&&f.push(p)}function b(){return{startTime:o,payload:e,status:i,queriesSent:c,queriesPending:v.length,subscribe:h,abort:g}}function y(){i="failed",f.forEach(p=>{p(void 0,d)})}function M(){v.forEach(p=>{p.status==="pending"&&(p.status="aborted")}),v=[]}function w(p,_,C){const S=_!=="success";switch(v=v.filter(m=>m!==p),i){case"pending":break;case"failed":if(S||!a.dataAfterTimeout)return;break;default:return}if(_==="abort"){d=C,y();return}if(S){d=C,v.length||(r.length?I():y());return}if(k(),M(),!a.random){const m=a.resources.indexOf(p.resource);m!==-1&&m!==a.index&&(a.index=m)}i="completed",f.forEach(m=>{m(C)})}function I(){if(i!=="pending")return;k();const p=r.shift();if(p===void 0){if(v.length){u=setTimeout(()=>{k(),i==="pending"&&(M(),y())},a.timeout);return}y();return}const _={status:"pending",resource:p,callback:(C,S)=>{w(_,C,S)}};v.push(_),c++,u=setTimeout(I,a.rotate),n(p,e,_.callback)}return setTimeout(I),b}function w1(a){const e={...s2,...a};let n=[];function s(){n=n.filter(o=>o().status==="pending")}function t(o,i,c){const d=l2(e,o,i,(u,v)=>{s(),c&&c(u,v)});return n.push(d),d}function l(o){return n.find(i=>o(i))||null}return{query:t,find:l,setIndex:o=>{e.index=o},getIndex:()=>e.index,cleanup:s}}function J(){}const F=Object.create(null);function r2(a){if(!F[a]){const e=U(a);if(!e)return;const n=w1(e),s={config:e,redundancy:n};F[a]=s}return F[a]}function c2(a,e,n){let s,t;if(typeof a=="string"){const l=N(a);if(!l)return n(void 0,424),J;t=l.send;const r=r2(a);r&&(s=r.redundancy)}else{const l=G(a);if(l){s=w1(l);const r=a.resources?a.resources[0]:"",o=N(r);o&&(t=o.send)}}return!s||!t?(n(void 0,424),J):s.query(e,t,n)().abort}function Y(){}function o2(a){a.iconsLoaderFlag||(a.iconsLoaderFlag=!0,setTimeout(()=>{a.iconsLoaderFlag=!1,a2(a)}))}function i2(a){const e=[],n=[];return a.forEach(s=>{(s.match(o1)?e:n).push(s)}),{valid:e,invalid:n}}function j(a,e,n){function s(){const t=a.pendingIcons;e.forEach(l=>{t&&t.delete(l),a.icons[l]||a.missing.add(l)})}if(n&&typeof n=="object")try{if(!h1(a,n).length){s();return}}catch{}s(),o2(a)}function a1(a,e){a instanceof Promise?a.then(n=>{e(n)}).catch(()=>{e(null)}):e(a)}function d2(a,e){a.iconsToLoad?a.iconsToLoad=a.iconsToLoad.concat(e).sort():a.iconsToLoad=e,a.iconsQueueFlag||(a.iconsQueueFlag=!0,setTimeout(()=>{a.iconsQueueFlag=!1;const{provider:n,prefix:s}=a,t=a.iconsToLoad;if(delete a.iconsToLoad,!t||!t.length)return;const l=a.loadIcon;if(a.loadIcons&&(t.length>1||!l)){a1(a.loadIcons(t,s,n),d=>{j(a,t,d)});return}if(l){t.forEach(d=>{const u=l(d,s,n);a1(u,v=>{const f=v?{prefix:s,icons:{[d]:v}}:null;j(a,[d],f)})});return}const{valid:r,invalid:o}=i2(t);if(o.length&&j(a,o,null),!r.length)return;const i=s.match(o1)?N(n):null;if(!i){j(a,r,null);return}i.prepare(n,s,r).forEach(d=>{c2(n,d,u=>{j(a,d.icons,u)})})}))}const u2=(a,e)=>{const n=e2(a,!0,v1()),s=Y1(n);if(!s.pending.length){let i=!0;return e&&setTimeout(()=>{i&&e(s.loaded,s.missing,s.pending,Y)}),()=>{i=!1}}const t=Object.create(null),l=[];let r,o;return s.pending.forEach(i=>{const{provider:c,prefix:d}=i;if(d===o&&c===r)return;r=c,o=d,l.push(x(c,d));const u=t[c]||(t[c]=Object.create(null));u[d]||(u[d]=[])}),s.pending.forEach(i=>{const{provider:c,prefix:d,name:u}=i,v=x(c,d),f=v.pendingIcons||(v.pendingIcons=new Set);f.has(u)||(f.add(u),t[c][d].push(u))}),l.forEach(i=>{const c=t[i.provider][i.prefix];c.length&&d2(i,c)}),e?n2(e,s,l):Y};function h2(a,e){const n={...a};for(const s in e){const t=e[s],l=typeof t;s in f1?(t===null||t&&(l==="string"||l==="number"))&&(n[s]=t):l===typeof n[s]&&(n[s]=s==="rotate"?t%4:t)}return n}const v2=/[\s,]+/;function p2(a,e){e.split(v2).forEach(n=>{switch(n.trim()){case"horizontal":a.hFlip=!0;break;case"vertical":a.vFlip=!0;break}})}function f2(a,e=0){const n=a.replace(/^-?[0-9.]*/,"");function s(t){for(;t<0;)t+=4;return t%4}if(n===""){const t=parseInt(a);return isNaN(t)?0:s(t)}else if(n!==a){let t=0;switch(n){case"%":t=25;break;case"deg":t=90}if(t){let l=parseFloat(a.slice(0,a.length-n.length));return isNaN(l)?0:(l=l/t,l%1===0?s(l):0)}}return e}function g2(a,e){let n=a.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in e)n+=" "+s+'="'+e[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+n+">"+a+"</svg>"}function k2(a){return a.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function w2(a){return"data:image/svg+xml,"+k2(a)}function _2(a){return'url("'+w2(a)+'")'}const t1={...g1,inline:!1},M2={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink","aria-hidden":!0,role:"img"},y2={display:"inline-block"},R={backgroundColor:"currentColor"},_1={backgroundColor:"transparent"},n1={Image:"var(--svg)",Repeat:"no-repeat",Size:"100% 100%"},e1={webkitMask:R,mask:R,background:_1};for(const a in e1){const e=e1[a];for(const n in n1)e[a+n]=n1[n]}const T={};["horizontal","vertical"].forEach(a=>{const e=a.slice(0,1)+"Flip";T[a+"-flip"]=e,T[a.slice(0,1)+"-flip"]=e,T[a+"Flip"]=e});function s1(a){return a+(a.match(/^[-0-9.]+$/)?"px":"")}const l1=(a,e)=>{const n=h2(t1,e),s={...M2},t=e.mode||"svg",l={},r=e.style,o=typeof r=="object"&&!(r instanceof Array)?r:{};for(let g in e){const h=e[g];if(h!==void 0)switch(g){case"icon":case"style":case"onLoad":case"mode":case"ssr":break;case"inline":case"hFlip":case"vFlip":n[g]=h===!0||h==="true"||h===1;break;case"flip":typeof h=="string"&&p2(n,h);break;case"color":l.color=h;break;case"rotate":typeof h=="string"?n[g]=f2(h):typeof h=="number"&&(n[g]=h);break;case"ariaHidden":case"aria-hidden":h!==!0&&h!=="true"&&delete s["aria-hidden"];break;default:{const b=T[g];b?(h===!0||h==="true"||h===1)&&(n[b]=!0):t1[g]===void 0&&(s[g]=h)}}}const i=F1(a,n),c=i.attributes;if(n.inline&&(l.verticalAlign="-0.125em"),t==="svg"){s.style={...l,...o},Object.assign(s,c);let g=0,h=e.id;return typeof h=="string"&&(h=h.replace(/-/g,"_")),s.innerHTML=N1(i.body,h?()=>h+"ID"+g++:"iconifyVue"),E("svg",s)}const{body:d,width:u,height:v}=a,f=t==="mask"||(t==="bg"?!1:d.indexOf("currentColor")!==-1),k=g2(d,{...c,width:u+"",height:v+""});return s.style={...l,"--svg":_2(k),width:s1(c.width),height:s1(c.height),...y2,...f?R:_1,...o},E("span",s)};v1(!0);R1("",J1);if(typeof document<"u"&&typeof window<"u"){const a=window;if(a.IconifyPreload!==void 0){const e=a.IconifyPreload,n="Invalid IconifyPreload syntax.";typeof e=="object"&&e!==null&&(e instanceof Array?e:[e]).forEach(s=>{try{typeof s!="object"||s===null||s instanceof Array||typeof s.icons!="object"||typeof s.prefix!="string"||T1(s)}catch{}})}if(a.IconifyProviders!==void 0){const e=a.IconifyProviders;if(typeof e=="object"&&e!==null)for(let n in e){const s="IconifyProviders["+n+"] is invalid.";try{const t=e[n];if(typeof t!="object"||!t||t.resources===void 0)continue;G1(n,t)}catch{}}}}const m2={...V,body:""},b2=c1((a,{emit:e})=>{const n=H(null);function s(){n.value&&(n.value.abort?.(),n.value=null)}const t=H(!!a.ssr),l=H(""),r=M1(null);function o(){const c=a.icon;if(typeof c=="object"&&c!==null&&typeof c.body=="string")return l.value="",{data:c};let d;if(typeof c!="string"||(d=z(c,!1,!0))===null)return null;let u=L1(d);if(!u){const k=n.value;return(!k||k.name!==c)&&(u===null?n.value={name:c}:n.value={name:c,abort:u2([d],i)}),null}s(),l.value!==c&&(l.value=c,x1(()=>{e("load",c)}));const v=a.customise;if(v){u=Object.assign({},u);const k=v(u.body,d.name,d.prefix,d.provider);typeof k=="string"&&(u.body=k)}const f=["iconify"];return d.prefix!==""&&f.push("iconify--"+d.prefix),d.provider!==""&&f.push("iconify--"+d.provider),{data:u,classes:f}}function i(){const c=o();c?c.data!==r.value?.data&&(r.value=c):r.value=null}return t.value?i():y1(()=>{t.value=!0,i()}),m1(()=>a.icon,i),b1(s),()=>{const c=r.value;if(!c)return l1(m2,a);let d=a;return c.classes&&(d={...a,class:c.classes.join(" ")}),l1({...V,...c.data},d)}},{props:["icon","mode","ssr","width","height","style","color","inline","rotate","hFlip","horizontalFlip","vFlip","verticalFlip","flip","id","ariaHidden","customise","title"],emits:["load"]});function j0(a){return c1({name:`Icon-${a}`,setup(e,{attrs:n}){return()=>E(b2,{icon:a,...e,...n})}})}const x2=`<?xml version="1.0" encoding="UTF-8"?>
...
</svg>`,H2=Object.freeze(Object.defineProperty({__proto__:null,default:I2},Symbol.toStringTag,{value:"Module"})),B2=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,F2=Object.freeze(Object.defineProperty({__proto__:null,default:B2},Symbol.toStringTag,{value:"Module"})),E2=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,l3=Object.freeze(Object.defineProperty({__proto__:null,default:s3},Symbol.toStringTag,{value:"Module"})),r3=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,c3=Object.freeze(Object.defineProperty({__proto__:null,default:r3},Symbol.toStringTag,{value:"Module"})),o3=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,i3=Object.freeze(Object.defineProperty({__proto__:null,default:o3},Symbol.toStringTag,{value:"Module"})),d3=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,b3=Object.freeze(Object.defineProperty({__proto__:null,default:m3},Symbol.toStringTag,{value:"Module"})),x3=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,H3=Object.freeze(Object.defineProperty({__proto__:null,default:I3},Symbol.toStringTag,{value:"Module"})),B3=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,F3=Object.freeze(Object.defineProperty({__proto__:null,default:B3},Symbol.toStringTag,{value:"Module"})),E3=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,Y3=Object.freeze(Object.defineProperty({__proto__:null,default:J3},Symbol.toStringTag,{value:"Module"})),a0=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,t0=Object.freeze(Object.defineProperty({__proto__:null,default:a0},Symbol.toStringTag,{value:"Module"})),n0=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,c0=Object.freeze(Object.defineProperty({__proto__:null,default:r0},Symbol.toStringTag,{value:"Module"})),o0=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
  ...
  <circle fill="none"
    ...
    stroke-linecap="round"
    stroke-linejoin="round" cx="11" cy="11" r="8" />
</svg>`,i0=Object.freeze(Object.defineProperty({__proto__:null,default:o0},Symbol.toStringTag,{value:"Module"})),d0=`<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
>
  <path fill="none"
...
</svg>`,b0=Object.freeze(Object.defineProperty({__proto__:null,default:m0},Symbol.toStringTag,{value:"Module"}));let r1=!1;r1||(C0(),r1=!0);function x0(a){const s=new DOMParser().parseFromString(a,"image/svg+xml").documentElement,t=[...s.childNodes].filter(d=>d.nodeType===Node.ELEMENT_NODE).map(d=>new XMLSerializer().serializeToString(d)).join(""),l=s.getAttribute("viewBox")||"",[r,o,i,c]=l.split(" ").map(d=>{const u=Number(d);return Number.isNaN(u)?void 0:u});return{body:t,height:c,left:r,top:o,width:i}}async function C0(){const a=Object.assign({"./icons/antdv-logo.svg":C2,"./icons/arrow-down.svg":j2,"./icons/arrow-left-to-line.svg":S2,"./icons/arrow-left.svg":L2,"./icons/arrow-right-left.svg":P2,"./icons/arrow-right-to-line.svg":V2,"./icons/arrow-right.svg":H2,"./icons/arrow-up-to-line.svg":F2,"./icons/arrow-up.svg":q2,"./icons/avatar-1.svg":N2,"./icons/avatar-2.svg":G2,"./icons/avatar-3.svg":U2,"./icons/avatar-4.svg":K2,"./icons/bell.svg":X2,"./icons/beller.svg":Y2,"./icons/cake.svg":t3,"./icons/card.svg":e3,"./icons/chevron-down.svg":l3,"./icons/chevron-left.svg":c3,"./icons/chevron-right.svg":i3,"./icons/chevrons-left.svg":u3,"./icons/chevrons-right.svg":v3,"./icons/circle-help.svg":f3,"./icons/copy.svg":k3,"./icons/corner-down-left.svg":_3,"./icons/download.svg":y3,"./icons/external-link.svg":b3,"./icons/fold-horizontal.svg":C3,"./icons/fullscreen.svg":j3,"./icons/inspection-panel.svg":S3,"./icons/languages.svg":L3,"./icons/lock-keyhole.svg":P3,"./icons/log-out.svg":V3,"./icons/mail-check.svg":H3,"./icons/maximize.svg":F3,"./icons/menu.svg":q3,"./icons/minimize-2.svg":N3,"./icons/minimize.svg":G3,"./icons/moon-star.svg":U3,"./icons/palette.svg":K3,"./icons/panel-left.svg":X3,"./icons/panel-right.svg":Y3,"./icons/pin-off.svg":t0,"./icons/pin.svg":e0,"./icons/rotate-cw.svg":l0,"./icons/search-x.svg":c0,"./icons/search.svg":i0,"./icons/settings.svg":u0,"./icons/square-pen.svg":v0,"./icons/sun-moon.svg":f0,"./icons/sun.svg":k0,"./icons/user-pen.svg":_0,"./icons/user-round-pen.svg":y0,"./icons/x.svg":b0});await Promise.all(Object.entries(a).map(e=>{const[n,s]=e,t=n.lastIndexOf("/")+1,l=n.lastIndexOf("."),r=n.slice(t,l);return p1(`svg:${r}`,{...x0(typeof s=="object"?s.default:s)})}))}export{b2 as I,j0 as c};
